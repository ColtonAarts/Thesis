...
testing_data = open("myTestData.csv", "r", encoding="utf8").read().split("\n")
# testing_data = open("noDuplicates25Test.csv", "r", encoding="utf8").read().split("\n")
...
# df_no_extra = pandas.read_csv("training.csv")
# df_no_extra = pandas.read_csv("myTrainingDataExpanded.csv")
# df_no_extra = pandas.read_csv("training_25.csv")
df_no_extra = pandas.read_csv("noDuplicates25Train.csv")
# df_no_extra = pandas.read_csv("noDuplicates25TrainExpanded.csv")
...
X_no_extra = tokenizer_no_extra.texts_to_sequences_old(df_no_extra['Tweet'].values)
...
neuralNetwork_no_extra.fit(X_no_extra, Y_no_extra, batch_size=64)
# neuralNetwork_no_extra.fit(X_no_extra, Y_no_extra, batch_size=10, validation_split = 0.05)
